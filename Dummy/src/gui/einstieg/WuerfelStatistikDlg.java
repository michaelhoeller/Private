...
public class WuerfelStatistikDlg extends SuperGUI {
	/**
	 * 
	 */
	...
	protected void initKomponenten() {
		...
		btnStatistikAnzeigen.addActionListener(e -> saveThrowAmount());

		btnGo = new JButton("Würfeln!");
		btnGo.setBounds(199, 104, 175, 20);
		btnGo.addActionListener(e -> doWuerfeling());
		...
		lbThrowAmountDisplay = new JLabel("214748364");
