...
public class DummyCreatorWindow {
    ...
    public void updateBar(int newValue, JProgressBar bar) {
    ...
    private void initialize() {
        ...
        frmDummyGeneratorV.setIconImage(Toolkit.getDefaultToolkit().getImage(DummyCreatorWindow.class.getResource("/recourses/elite-dangerous-logo_grey.png")));
        ...
        textFieldSaveLocation.setText("C://temp/DummyFile.sql");
                    ...
                    .addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
                        .addGroup(groupLayout.createSequentialGroup()
                            .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                                ...
                                .addComponent(labelTitel, GroupLayout.DEFAULT_SIZE, 774, Short.MAX_VALUE))
                            .addContainerGap())
                        .addGroup(groupLayout.createSequentialGroup()
                            .addGroup(groupLayout.createParallelGroup(Alignment.LEADING, false)
                                .addComponent(labelSaveLocation, GroupLayout.PREFERRED_SIZE, 220, GroupLayout.PREFERRED_SIZE)
                                .addComponent(textFieldDummyAmount)
                                .addComponent(lblAnzahl, GroupLayout.PREFERRED_SIZE, 220, Short.MAX_VALUE)
                                .addComponent(textFieldSaveLocation))
                            .addPreferredGap(ComponentPlacement.RELATED, 298, Short.MAX_VALUE)
                            .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                                .addComponent(tglbtnStakeholderGenerieren, GroupLayout.PREFERRED_SIZE, 225, GroupLayout.PREFERRED_SIZE)
                                .addComponent(tglbtnUserGenerieren, GroupLayout.PREFERRED_SIZE, 225, GroupLayout.PREFERRED_SIZE))
                            .addGap(24)))));
        groupLayout.setVerticalGroup(
            groupLayout.createParallelGroup(Alignment.TRAILING)
                .addGroup(groupLayout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(labelTitel, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
                    .addGap(37)
                    .addComponent(labelSaveLocation)
                    .addPreferredGap(ComponentPlacement.RELATED)
                    .addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
                        .addGroup(groupLayout.createSequentialGroup()
                            .addComponent(textFieldSaveLocation, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                            .addGap(18)
                            .addComponent(lblAnzahl, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(ComponentPlacement.RELATED)
                            .addComponent(textFieldDummyAmount, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                        .addComponent(tglbtnUserGenerieren, GroupLayout.PREFERRED_SIZE, 82, GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(ComponentPlacement.UNRELATED)
                    .addComponent(tglbtnStakeholderGenerieren, GroupLayout.PREFERRED_SIZE, 82, GroupLayout.PREFERRED_SIZE)
